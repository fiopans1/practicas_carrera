 ...
 * GROUP: 2.3
 */
public class Estudiante extends Residentes {
    private static final int g_h=90;
    public Estudiante(String nombre, String apellido, int edad,int horrocruxs, Casas casa) {
    ...
    public String getRecompensa() {
        ...
        s.append(super.getNombre()).append(" ").append(super.getApellido()).append("(").append(
                "Estudiante de ").append(super.getCasa().toString()).append(",").append(super.getHorrocruxs()).append(
